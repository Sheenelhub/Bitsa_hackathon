            ...
            <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
              <div className="sm:text-center lg:text-left">
                ...
                <p className="mt-3 text-base text-blue-100 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                  ...
                  Join us to stay connected with the latest updates, events, and opportunities.
                </p>
          ...
          <div className="mt-10">
            <div className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
              <div className="relative">
                ...
                <p className="ml-16 text-lg leading-6 font-medium text-gray-900">Blog & Announcements</p>
                <p className="mt-2 ml-16 text-base text-gray-500">
                  Stay updated with the latest articles, announcements, and updates from BITSA.
                </p>
              </div>
              ...
              <div className="relative">
                ...
                <p className="mt-2 ml-16 text-base text-gray-500">
                  Discover and register for upcoming BITSA activities, workshops, and programs.
                </p>
              </div>
              ...
              <div className="relative">
                ...
                <p className="ml-16 text-lg leading-6 font-medium text-gray-900">Gallery</p>
                <p className="mt-2 ml-16 text-base text-gray-500">
                  Browse photos from past events and memorable moments.
                </p>
              </div>
              ...
              <div className="relative">
                ...
                <p className="mt-2 ml-16 text-base text-gray-500">
                  Connect with fellow students and engage with the BITSA community.
                </p>
              </div>
            </div>
          </div>
